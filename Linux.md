...
**1. 一个程序从开始运行到结束的完整过程。** 
	...
	A: 1. 预编译: 使用-E指令会使程序只进行到预编译指令。经过预编译指令后的会生成一个.i文件。
	   ...
	   <img class="inline" src="https://raw.github.com/cloi1994/TC/blob/master/1338355-20180304130814151-249194330.pngg" width="40%">
